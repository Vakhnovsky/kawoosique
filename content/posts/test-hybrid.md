---
title: "🗡️ Обзор кастомного клинка: Первые впечатления"
date: 2026-06-17
draft: false
tg_mode: "hybrid"
cover:
...
# Идеальный баланс геометрии и эргономики

Сегодня приехал новый кастом. Первое, на что обращаешь внимание — это баланс. Нож сидит в руке как влитой, грани рукояти зализаны идеально, никакой агрессии к ладони.

* **Длина клинка:** 95 мм
* **Обух:** 3.5 мм — золотая середина
* **Сведение:** 0.2 мм — резак феноменальный

![Общий план ножа на веточках](/images/13.jpg)

Ниже представлена формула идеального угла заточки (да, Телеграм теперь понимает математические выражения!):

$$ \alpha = \arcsin\left(\frac{h}{L}\right) $$

На этом превью для канала заканчивается. Всё, что пойдет ниже разделителя, улетит на сайт, а читатель в ТГ получит ссылку на Instant View.

---tg---

## Детальные тесты и полевые испытания (Только для сайта/IV)

Мы поехали в лес, чтобы проверить геометрию по плотной древесине. Сухой дуб нож строгает неохотно из-за тонкого сведения — есть риск покрошить кромку. Но по продуктам и канату — это абсолютный космос.

![Тест на весу по канату](/images/14.jpg)

Канат диаметром 20 мм был перерезан за один проход без видимых усилий со стороны кисти. После 50 резов брить предплечье нож не перестал.
