---
title: "🗡️ Обзор кастомногоооо клинка: Первые впечатления"
date: 2026-06-17
draft: false
tg_mode: "hybrid"
cover:
...
Текст превью, который улетит в телеграм... Моя чудная статья (кликайте на неё) Поверочка
<!--tg-->
А этот текст начнется уже после разделителя. На сайте он будет, а в ТГ бот его не пустит, заменив ссылкой на Instant View.
* **Длина клинка:** 95 мм
